...
const imagePreview = ref(props.producto.imagen_url || null);
...
function submit() {
    ...
    form.transform((data) => ({
        ...data,
        _method: 'PUT',
    })).post(route('restaurant.productos.update', props.producto.id), {
        forceFormData: true,
    });
}
</script>
...
<template>
    <AppLayout>
        <Head title="Editar Producto - Restaurante" />
            ...
            <div class="flex-1">
                ...
                <div class="mb-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold" style="color: var(--color-text-primary)">Editar Producto</h1>
                ...
                <div class="card rounded-lg shadow-sm p-6 max-w-2xl">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div>
                            ...
                            <!-- Imagen Actual -->
                            <div v-if="producto.imagen_url && !imagePreview" class="mt-2 mb-4">
                                <p class="text-sm font-medium mb-2">Imagen Actual:</p>
                                <img :src="producto.imagen_url" :alt="producto.nombre" class="w-48 h-48 object-cover rounded-lg shadow-md" />
                            </div>
                            ...
                            />
                            <p class="text-xs text-gray-500 mt-1">Formatos: JPG, PNG, GIF, WEBP. Máximo 2MB. Dejar vacío para mantener la imagen actual.</p>
                            
                            <!-- Preview Nueva Imagen -->
                            <div v-if="imagePreview && imagePreview !== producto.imagen_url" class="mt-4">
