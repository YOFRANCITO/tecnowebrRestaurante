...
function submit() {
    form.post(route('restaurant.proveedores.store'));
}
</script>

<template>
    <AppLayout>
        <Head title="Crear Proveedor - Restaurante" />
            ...
            <div class="flex-1">
                <div class="mb-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold" style="color: var(--color-text-primary)">Crear Proveedor</h1>
                            <p class="text-sm mt-1" style="color: var(--color-text-secondary)">Registra un nuevo proveedor</p>
                        </div>
                    </div>
                </div>
